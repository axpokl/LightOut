...
h:=len shr 1;
KarRecPair(a,ao,b,bo,c,co,r,ro,s,so,h,work,wo);
KarRecPair(a,ao+h,b,bo+h,c,co+h,r,ro+(h shl 1),s,so+(h shl 1),h,work,wo);
...
procedure KarMulPair(const a,b,c:TDynBool; var r,s:TDynBool; len:longint);
var work:TDynBool;
var i0:longint;
begin
SetLength(r,len shl 1);
...
KarRecPair(a,0,b,0,c,0,r,0,s,0,len,work,0);
end;
...
KarMulPair(ha,hb,hbr,prod0,prod1,halfPad);
for i0:=0 to hi do
  begin
  p:=i0+1;
