...
{ H46: use an exact, non-power-of-two paired Karatsuba recursion. }
{ A and B use the same 32-bit-block recursion, 8-coefficient leaves and 128-bit cutoff. }
...
SetLength(ha,convBits); SetLength(hb,convBits); SetLength(hbr,convBits);
