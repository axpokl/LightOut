...
{ H66: reuse identical reflected-source convolution products. }
...
{ H65: low product. The high-high product starts at 2*h >= lim.
  Compute low-low once, then the two truncated cross products. }
...
if (mode<>0) and sameSource then prod1:=prod0;
for i0:=0 to hi do
  begin
  p:=i0+1;
  if mode=0 then
