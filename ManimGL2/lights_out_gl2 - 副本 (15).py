...
def hl_bd(scene, grids, color=HL_COLOR, width=BD_W_SEL, buff=0.06, rt=0.3):
...
#演示n=5,7,11
        ...
        show_subtitle(self, "由于右边一个按钮矩阵就是左边一个灯矩阵，", "这边我们就仅看按钮矩阵。")
        ...
        self.wait(1)
        LAT1_7 = show_latex(self, "<cY>0⊕0⊕0⊕0", 0, 1.5, show=False)
        trans_latex(self, LAT1_6, LAT1_7)
        self.wait(2)
        LAT1_8 = show_latex(self, "<cY>B(n,x-1,y)⊕B(n,x+1,y)⊕B(n,x,y-1)⊕B(n,x,y+1)=0", 0, 1.5, show=False)
