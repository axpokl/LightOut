...
{ H44: compute the two shared-left Karatsuba products in one recursion. }
...
procedure KarRecPairW(const a:TWordArray; ao:longint;
                      ...
                      var s:TWordArray; so,len:longint;
...
h:=len shr 1;
KarRecPairW(a,ao,b,bo,c,co,r,ro,s,so,h,work,wo);
KarRecPairW(a,ao+h,b,bo+h,c,co+h,r,ro+(h shl 1),s,so+(h shl 1),h,work,wo);
...
procedure KarMulPairFastW(const a,b,c:TWordArray; var r,s:TWordArray; len:longint);
var work:TWordArray;
var i0:longint;
begin
SetLength(r,len shl 1);
...
KarRecPairW(a,0,b,0,c,0,r,0,s,0,len,work,0);
end;
